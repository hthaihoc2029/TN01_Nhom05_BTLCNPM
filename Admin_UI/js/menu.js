...
<div class="row ps-5">
    <div class="row mt-2 mb-2 text-start">
        <a class="menu_text menu_widget text-start btn-sm" id="printer_management_button" href="printer_management.html">
            <img src="image/menu/print.png" alt="printer_management" class="pe-2 menu_text">
            Máy in
        </a>
    </div>
    <div class="row my-2">
        <a class="menu_text menu_widget text-start btn-sm" id="printer_management_button">
            <img src="image/menu/okay.png" alt="accept" class="pe-2">
            Xác nhận in
        </a>
    </div>
    <div class="row my-2">
    ...
    <div class="row my-2">
        <a class="menu_text menu_widget text-start btn-sm" id="revenue_button">
            <img src="image/menu/money.png" alt="revenue" class="pe-2">
            Doanh thu
        </a>
    </div>
    <div class="row my-2">
        <a class="menu_text menu_widget text-start btn-sm" id="notification_button">
            <img src="image/menu/notify.png" alt="notification" class="pe-2">
            Thông báo
        </a>
    </div>
    <div class="row my-2">
        <a class="menu_text menu_widget text-start btn-sm" id="response_button">
            <img src="image/menu/ask.png" alt="response" class="pe-2">
            Phản hồi
        </a>
    </div>
